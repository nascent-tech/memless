...
| Pont PHP | **FFI** intégré à PHP (`ext-ffi`), PHP ≥ 8.1 (testé en CI : 8.3 sur Linux et macOS arm64, 8.5 préinstallé sur macOS Intel ; 8.5 en local) | la porte déjà percée dans PHP depuis 2019 pour appeler une bibliothèque native, sans rien compiler de spécifique à PHP (§5.2 du brief) |
